...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('indicadores_logro', function (Blueprint $table) {
            $table->uuid('id_indicador')->primary(); // Definimos la clave primaria para la tabla
            $table->string('descripcion'); // Descripción del indicador de logro
            $table->uuid('id_unidad_didactica'); // Clave foránea que hace referencia a unidades_didacticas
